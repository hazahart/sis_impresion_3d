...
class _CotizacionScreenState extends ConsumerState<CotizacionScreen> {
                ...
                child: ElevatedButton(
                  ...
                  onPressed: _isFormValid ? () {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(content: Text('Formulario válido. Calculando...')),
                    );
                  } : null,
                  child: const Text(
                    'Calcular',
  ...
  Widget _buildInputField({
    ...
    return TextFormField(
      ...
      decoration: _getCustomDecoration(label: label, tieneError: tieneError).copyWith(
        hintText: hint,
        errorText: tieneError ? errorActual : null,
      ),
      onChanged: (value) {
        setState(() {
